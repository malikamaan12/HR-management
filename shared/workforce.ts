...
export const grantInput = z.object({userId: positiveId, permission: z.enum(['view', 'schedule']), startAt: instant, endAt: instant}).strict().refine(v => v.endAt > v.startAt, 'End must be after start');
