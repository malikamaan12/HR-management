...
export const inductionSettings=z.object({
 ...
 reviewRequired:z.boolean(),enrollmentApprovalRequired:z.boolean(),allowSelfEnrollment:z.boolean(),mandatoryForOnboarding:z.boolean(),defaultDueDays:z.number().int().min(0).max(365),
