...
export interface TeamOverview {
  ...
  staffing:{shifts:number;required:number;accepted:number;unfilled:number;pendingOffers:number;gaps:{id:number;role:string;startAt:string;endAt:string;unfilled:number}[]};
