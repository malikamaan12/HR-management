...
export const pages:PageDefinition[]=[
 ...
 {href:'/end-of-service',label:'End of Service',icon:'file-signature',section:'People',access:'signed_in'},
 ...
 {href:'/contracts',label:'Contracts',icon:'file-signature',section:'HR services',access:'signed_in'},
