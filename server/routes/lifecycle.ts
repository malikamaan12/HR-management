...
import { z } from 'zod';
import { and, eq, or, desc, sql, gte, inArray } from 'drizzle-orm';
import { db } from '../db';
import { employees, users, authSessions, lifecycleCases as cases, lifecycleTasks as tasks, lifecycleTemplates as templates, workforceAssignments, workforceShifts, workforceTeams, workforceSites } from '@shared/schema';
