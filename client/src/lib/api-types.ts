...
export type ApiDocument = Jsonify<Schema.Document> & { employeeName?: string; currentVersion?: number; canReplace?: boolean; canRequestRenewal?: boolean; approvalRequired?: boolean; changeReason?: string };
