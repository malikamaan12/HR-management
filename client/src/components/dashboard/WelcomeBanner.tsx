...
import {canOpenPage,pageForPath} from '@shared/navigation';
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div className="space-y-2 min-w-0">
          ...
          <p className="text-white/80 text-base sm:text-lg">
            Your workforce overview, limited to your access scope.
          </p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          {user&&hasPermission(user.role,'employee_database','read')&&<div className="bg-white/10 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-white/20">
          ...
          {user&&hasPermission(user.role,'leave_absence_management','read')&&<div className="bg-white/10 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-white/20">
            <div className="flex items-center gap-2 mb-1">
          ...
          {user&&hasPermission(user.role,'compliance_documents','read')&&<div className="bg-white/10 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-white/20">
            <div className="flex items-center gap-2 mb-1">
          ...
          {canOpenPage(user?.role,pageForPath('/event-staff')!)&&<div className="bg-white/10 backdrop-blur-md rounded-2xl p-3 sm:p-4 border border-white/20">
            <div className="flex items-center gap-2 mb-1">
