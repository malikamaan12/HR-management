        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto py-4">
            <ul className="space-y-1 px-3">
              ...
              <li><Link href="/hr-letters" className={cn('sidebar-item flex items-center px-3 py-2 rounded-md hover:bg-primary/10',location.startsWith('/hr-letters')&&'border-l-4 border-primary bg-primary/10 font-medium')}><i className="fas fa-file-signature w-6 text-primary"/><span className="ml-3">HR Letter Centre</span></Link></li>
              <li><Link href="/org-charts" className="sidebar-item flex items-center px-3 py-2 rounded-md hover:bg-primary/10"><i className="fas fa-sitemap w-6 text-primary"/><span className="ml-3">Organization charts</span></Link></li>
              <li><Link href="/team-overview" className={cn('sidebar-item flex items-center px-3 py-2 rounded-md hover:bg-primary/10',location.startsWith('/team-overview')&&'border-l-4 border-primary bg-primary/10 font-medium')}><i className="fas fa-users w-6 text-primary"/><span className="ml-3">Team overview</span></Link></li>
              <li><Link href="/assignment-reviews" className={cn('sidebar-item flex items-center px-3 py-2 rounded-md hover:bg-primary/10',location.startsWith('/assignment-reviews')&&'border-l-4 border-primary bg-primary/10 font-medium')}><i className="fas fa-star w-6 text-primary"/><span className="ml-3">Assignment reviews</span></Link></li>
