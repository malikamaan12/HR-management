...
export default function Sidebar({className}:{className?:string}){
 ...
 <Link href="/" className="flex items-center gap-3 border-b p-4"><BrandLogo/><span className="min-w-0"><span className="block font-semibold break-words">{branding.applicationName}</span><span className="text-xs text-muted-foreground break-words">{branding.tagline}</span></span></Link>
