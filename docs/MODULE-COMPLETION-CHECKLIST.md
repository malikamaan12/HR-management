...
18 September 2026 next batch: versioned lifecycle templates, owner submission, independent HR approval/return, admin review rules, evidence validity and review queues are implemented and verified locally. See [LIFECYCLE-REVIEW-RELEASE.md](LIFECYCLE-REVIEW-RELEASE.md). Deployment verification is pending. Next: equipment issue/return and handbook acknowledgements.
